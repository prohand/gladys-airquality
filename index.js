// -----------------------------------------------------------------------------
// Entry point of the Air quality integration.
//
...
import { findProvider } from './src/airQuality/index.js';
...
// for an hourly analysis — so the integration drives its own refresh.
let pollingCleanups = [];

// Shown in the Supervision screen while no location has been added yet.
const NOT_CONFIGURED_MESSAGE = {
  en: 'Add a location to start following the air quality.',
  fr: "Ajoutez un lieu pour suivre la qualité de l'air.",
};
