...
//     `config_schema` of `gladys-assistant-integration.json` (the language of
//     the device names and the refresh interval). Their defaults below MUST
...
export const DEFAULT_CONFIG = {
  // The CAMS analysis is produced hourly: polling faster than that just returns
  // the same numbers.
  poll_frequency: 3600,
