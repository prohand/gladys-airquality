...
// Device registry.
//
// This integration has a single device TYPE (the air quality station) but a
// variable NUMBER of devices: one per location the user configured. So the
// registry is not a static list of blueprints like in the template — each
// blueprint is a projection of `config.locations`.
//
...
import { airQualityStation } from './airQualityStation.js';

export const DEVICE_BLUEPRINTS = [airQualityStation];
